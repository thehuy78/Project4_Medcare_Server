...
@Repository
public interface TestingRepositoty extends JpaRepository<Test, Long> {
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.ITesting$TestingRes(" +
