...
public interface BookingRepository extends JpaRepository<Booking, Long> {
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        "(:search IS NULL OR :search = '' OR LOWER(d.user.email) LIKE LOWER(CONCAT('%', :search, '%'))OR LOWER(d.brief.name) LIKE LOWER(CONCAT('%', :search, '%'))OR LOWER(d.brief.phone) LIKE LOWER(CONCAT('%', :search, '%'))) "
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByFilters(
                        ...
                        @Param("endDate") Date endDate, // New parameter for end date
                        Pageable pageable);
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByFiltersDoctor(
                        @Param("search") String search,
                        @Param("gender") String gender,
                        @Param("type") String type,
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByFiltersPack(
                        @Param("search") String search,
                        @Param("gender") String gender,
                        @Param("type") String type,
                        @Param("typeUrl") String typeUrl,
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByFiltersTest(
                        @Param("search") String search,
                        @Param("gender") String gender,
                        @Param("type") String type,
                        @Param("typeUrl") String typeUrl,
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByFiltersVaccine(
                        @Param("search") String search,
                        @Param("gender") String gender,
                        @Param("type") String type,
                        @Param("typeUrl") String typeUrl,
        ...
        @Query("SELECT new projectsem4.medcare_server.interfaces.admin.IBooking$BookingRes(" +
                        ...
                        +
                        "ORDER BY d.createDate DESC")
        Page<BookingRes> findByHospitalType(
                        @Param("search") String search,
